<?php
	...
	FacebookSession::setDefaultApplication( '1777314269241176','fc3977c243043c85c116fcb6e70ea60f' );
	$helper = new FacebookRedirectLoginHelper('http://localhost:8080/social_login/loginFB.php');
